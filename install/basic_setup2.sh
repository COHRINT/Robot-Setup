...
# Have build point to the correct kernel
rm /lib/modules/3.8.13.30/build
ln -s /usr/src/linux-headers-3.8.13.30/ /lib/modules/3.8.13.30

# ln -sfn /usr/src/3.8.13.30 in /lib/modules/3.8.13.30
...
cd - # do we go to cohrint_turtlebot/install ?
...
echo "The system will reboot, when it begins again the wifi dongle should be blinking and $ ssh odroid@$robot_name will be possible. Press [ENTER] to continue."
read -n 1
